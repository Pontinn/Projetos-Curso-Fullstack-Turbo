...
let firstDiceImage = document.querySelectorAll('img')[0].setAttribute('src', randomImageSource)
let secondDiceImage = document.querySelectorAll('img')[1].setAttribute('src', randomImageSource2)
